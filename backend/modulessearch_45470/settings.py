"""
Django settings for modulessearch_45470 project.
...
ROOT_URLCONF = 'modulessearch_45470.urls'
...
WSGI_APPLICATION = 'modulessearch_45470.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "modulessearch_45470 API",
    "DESCRIPTION": "API documentation for modulessearch_45470 App",
    "VERSION": "v1",
}
